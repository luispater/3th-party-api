...
ps：必应词典在本地存有数据库，所以它的联想功能是直接在数据库中查找 —— [戳我下载 Android 数据库文件](https://github.com/shichunlei/-Api/blob/master/bing词典.db) 或 [戳我下载 wps 表格](https://github.com/shichunlei/-Api/blob/master/Bing词典.xlsx)。**本地数据库中包含单词的基础默认翻译**
