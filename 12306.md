...
请求中可能需要使用到火车出发站、始发站、到达站、终点站所对应的代号，我已经将相应的数据转成了 WPS 的表格，[点我查看文件](https://github.com/shichunlei/-Api/blob/master/train_station_code.xlsx)，下载后可以用 WPS 或 Excel 打开即可，或自行转成数据库文件，文件中的 `teleCode
` 列就是相应的站点代号了。
